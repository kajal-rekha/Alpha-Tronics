...
function saveInLocalStorage(product) {
    ...
    // if not exixts , set
    if (!gettingLocalData) localStorage.setItem(`item-${product.id}`, JSON.stringify(product));
}
          ...
          >
            ...
            <div class="texts flex flex-col gap-2">
              ...
              <div class="flex justify-between items-center gap-3">
                <p class="price font-bold text-rose-500">${currencyFormatter(product.price)}</p>
                <p
